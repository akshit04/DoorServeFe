...
const Cart: React.FC = () => {
    ...
    const { data: cartItems = [], isLoading, error } = useQuery({
        ...
        queryFn: async () => {
            ...
            console.log('Cart items received:', result);
            return result;
        },
    });
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-start justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 mb-1">by {item.provider?.name || 'Provider'}</p>
                                            <p className="text-sm text-gray-600 mb-2">{item.service?.description || 'Service description'}</p>
                                            <div className="flex items-center space-x-4 text-sm text-gray-500">
                                                <span>{item.service?.category || 'Category'}</span>
                                                <span>•</span>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <span>{(item.provider?.rating || 0).toFixed(1)}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <button
