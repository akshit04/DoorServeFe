...
const Footer: React.FC = () => {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'For Partners',
      links: [
        { label: 'Become a Partner', path: '/register?type=partner' },
        { label: 'Partner Dashboard', path: '/partner' },
        { label: 'Partner Resources', path: '/partner/resources' },
        { label: 'Partner Support', path: '/partner/help' },
      ]
    },
    {
      title: 'Company',
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.418-3.323c.875-.875 2.026-1.297 3.323-1.297s2.448.422 3.323 1.297c.928.875 1.418 2.026 1.418 3.323s-.49 2.448-1.418 3.244c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.404h-1.507V6.077h1.507v1.507zm-.85 5.823c0-.932-.422-1.777-1.092-2.447-.67-.67-1.515-1.092-2.447-1.092s-1.777.422-2.447 1.092c-.67.67-1.092 1.515-1.092 2.447s.422 1.777 1.092 2.447c.67.67 1.515 1.092 2.447 1.092s1.777-.422 2.447-1.092c.67-.67 1.092-1.515 1.092-2.447z"/>
        </svg>
      )
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <span className="text-2xl font-bold">DoorServe</span>
          </div>
          <p className="text-gray-300 max-w-md text-lg">
            Your trusted platform for professional home services. Quality, reliability, and convenience delivered to your doorstep.
          </p>
        ...
        <div className="bg-gray-800 rounded-2xl p-8 mb-12">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 mb-6">
              Get the latest updates on new services, special offers, and home maintenance tips.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} DoorServe. All rights reserved.
            </div>
